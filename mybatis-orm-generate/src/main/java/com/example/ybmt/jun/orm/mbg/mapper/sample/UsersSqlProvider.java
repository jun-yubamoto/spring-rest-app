...
import com.example.ybmt.jun.orm.mbg.model.sample.UsersExample.Criteria;
import com.example.ybmt.jun.orm.mbg.model.sample.UsersExample.Criterion;
...
public class UsersSqlProvider {
    ...
    public String countByExample(UsersExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sample.users");
